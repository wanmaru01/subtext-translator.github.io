...
function showRandomWindow(content) {
  ...
  randomWindow.style.position = "fixed";
  randomWindow.style.width = "300px";
  randomWindow.style.height = "300px";
  randomWindow.style["border-top"] = "5px solid #fff";
  randomWindow.style["border-left"] = "5px solid gray";
  randomWindow.style["border-bottom"] = "5px solid gray";
  randomWindow.style["box-shadow"] =
    "inset 5px 5px #dfdfdf, 5px 0 #000, 0 5px #000, 5px 5px #000";
  randomWindow.style.backgroundColor = "silver";
  randomWindow.style.padding = "10px";
  randomWindow.style.zIndex = "1000";
  randomWindow.style.overflow = "auto";
